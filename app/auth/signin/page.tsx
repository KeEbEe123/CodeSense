...
export default function SignInPage() {
  ...
  return (
    <div className="relative flex justify-center items-center h-screen overflow-hidden">
      ...
      {/* Overlay Content */}
      <div className="relative z-10 flex flex-col lg:flex-row min-h-[20%] m-4 rounded-3xl w-full lg:w-1/2 justify-center lg:justify-start items-center p-8 space-y-6 lg:space-y-0 lg:space-x-6 lg:mr-72 lg:mb-20">
